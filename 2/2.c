...
void translate2D (GLfloat tx, GLfloat ty)
{
		...
		matTransl [0][2] = tx; // last column first row
		matTransl [1][2] = ty; // llast col second row
...
void triangle(wcPt2D *verts) // important * before the name of the array
{
	GLint k;
...
// to find the center point of the trianlge
wcPt2D centroidPt;
